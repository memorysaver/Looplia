...
function RouteComponent() {
  ...
  useEffect(() => {
    if (name) {
      setIsLoading(true)
      trpcClient.greeting.query({ name })
        .then(setGreeting)
        .catch(console.error)
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test type-safe API calls with tRPC
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {isLoading && name && (
            <p className="text-muted-foreground">Loading greeting...</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fetched via tRPC from the server
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add a new user via tRPC mutation
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Various UI components from the Shadcn library
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
