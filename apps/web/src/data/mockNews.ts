...
export const mockNewsData: MockNewsItem[] = [
  {
    ...
    excerpt: 'Scientists at leading tech companies have developed an AI system that demonstrates unprecedented reasoning capabilities, potentially transforming how we approach complex problem-solving in various industries.',
  ...
  },
  {
    ...
    excerpt: 'World leaders unite on ambitious climate goals with new framework for international cooperation and sustainable development initiatives.',
  ...
  },
  {
    ...
    excerpt: 'The revolutionary payment platform attracts major investors with its innovative approach to cross-border transactions and cryptocurrency integration.',
  ...
  },
  {
    ...
    excerpt: 'Major milestone in quantum computing as researchers demonstrate stable quantum operations without decoherence, opening doors to practical quantum applications.',
  ...
  },
  {
    ...
    excerpt: 'The new platform promises immersive entertainment experiences combining traditional streaming with virtual reality technology.',
  ...
  },
  {
    ...
    excerpt: 'Against all odds, the team overcame a 3-0 deficit to win the championship in one of the most memorable sports comebacks in recent history.',
  ...
  },
  {
    ...
    excerpt: 'New solar technology achieves unprecedented efficiency rates, making renewable energy more cost-effective than traditional energy sources in most markets.',
  ...
  },
  {
    ...
    excerpt: 'Technology sector shows strong performance as major companies exceed quarterly expectations, driving investor confidence and market growth.',
  ...
  },
  {
    ...
    excerpt: 'Latest data from the Mars rover reveals complex geological formations suggesting the presence of extensive water systems billions of years ago.',
  ...
  },
  {
    ...
    excerpt: 'Security experts develop advanced encryption methods to protect sensitive information in distributed work environments.',
  ...
  },
  {
    ...
    excerpt: 'International artists present innovative storytelling techniques that challenge conventional narratives and explore diverse cultural perspectives.',
  ...
  },
  {
    ...
    excerpt: 'Economic indicators suggest a potential turning point as central banks implement strategic monetary policies to address inflation concerns.',
